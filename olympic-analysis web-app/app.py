...
df = pd.read_csv('C:/Users/91969\Desktop/Untitled Folder/athlete_events.csv')
region_df = pd.read_csv('C:/Users/91969/Desktop/Untitled Folder/noc_regions.csv')
...
if user_menu == 'Medal Tally':
    ...
    if selected_country != 'Overall' and selected_year != 'Overall':
        st.title("Medal tally in "+str(selected_year)+" of "+str(selected_country))
...
if user_menu == 'Athlete-wise Analysis':
    ...
    famous_sports = ['Basketball', 'Judo', 'Football', 'Tug-Of-War', 'Athletics', 'Swimming', 'Badminton', 'Sailing',
                     ...
                     'Rhythmic Gymnastics', 'Triathlon', 'Rugby Sevens', 'Beach Volleyball', 'Rugby', 'Polo',
                     'Ice Hockey']
    x = []
    name = []
